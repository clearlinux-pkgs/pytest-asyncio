...
Source0  : https://files.pythonhosted.org/packages/74/83/cb798453b2567ba0b8b35db05df3dda6ec0412f250b47a0cf19f37752a84/pytest-asyncio-0.12.0.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.12.0
cd %{_builddir}/pytest-asyncio-0.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588628388
...
cp %{_builddir}/pytest-asyncio-0.12.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-asyncio/c700a8b9312d24bdc57570f7d6a131cf63d89016
