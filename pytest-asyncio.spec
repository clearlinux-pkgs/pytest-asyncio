...
Source0  : https://files.pythonhosted.org/packages/de/c1/b2b0119e30f61f7ec8b44f129f6fde46a1a7329de17110f124639aa8896b/pytest-asyncio-0.15.1.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.15.1
cd %{_builddir}/pytest-asyncio-0.15.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619143966
...
cp %{_builddir}/pytest-asyncio-0.15.1/LICENSE %{buildroot}/usr/share/package-licenses/pytest-asyncio/c700a8b9312d24bdc57570f7d6a131cf63d89016
