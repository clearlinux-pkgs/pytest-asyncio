...
Source0  : https://files.pythonhosted.org/packages/5f/be/288b5aed3bf0e4297859c3a1e3eaaaf809cbc1e1f6bdadf5b03276d18cb5/pytest-asyncio-0.15.0.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.15.0
cd %{_builddir}/pytest-asyncio-0.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618844289
...
cp %{_builddir}/pytest-asyncio-0.15.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-asyncio/c700a8b9312d24bdc57570f7d6a131cf63d89016
